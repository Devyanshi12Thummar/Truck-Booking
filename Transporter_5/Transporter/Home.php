    ...
    <div class="main-panel">
      <div class="content-wrapper">
        ...
        <div class="row">
          ...
          $driver =  mysqli_query($conn, "select * from truck_driver where driver_active_status='1' ");
          $drivercount = mysqli_num_rows($driver);
                    ...
                    <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                      <div class="d-flex flex-wrap justify-content-xl-between">
                        ...
                        <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                          ...
                          <div class="d-flex flex-column justify-content-around">
                            <small class="mb-1 text-muted">Active Driver</small>
                            <h5 class="me-2 mb-0"><?php echo $drivercount ?></h5>
                          </div>
                        </div>
          ...
          <div class="row">
            <div class="col-md-7 grid-margin stretch-card">
              <div class="card">
                <div id="reportsChart" style=" margin-left:-25px;height: 500px; width: 810px;" class="card-body">
            ...
            <div class="col-md-5 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3>Last 3 year Total Payment</h3><br>


                  <!-- <h1>10</h1>/  -->
                  <h6 class="card-title">Payment over the years</h6>
                  ...
                  <div id="total-sales-chart-legend"><canvas id="booking-chart" height="200">
                    </canvas></div>
                </div>
