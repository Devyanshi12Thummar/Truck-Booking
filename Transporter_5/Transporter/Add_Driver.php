...
if (isset($_POST['adddriver'])) {
    ...
    if (empty($Email)) {
        ...
        if ($result->num_rows > 0) {
            ...
            $stmt = $conn->prepare("INSERT INTO truck_driver (driver_fullname, driver_email, driver_contactno_primary, driver_contactno_secoundary, driver_address, driver_city, driver_pincode, driver_license, driver_password, driver_active_status) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

            if (!$stmt) {
                die("Error in prepare statement: ");
            }
            $driver_active_status = '0';
            $stmt->bind_param("ssssssssss", $Fullname, $Email, $Primarycontact, $Secondarycontact, $Address, $City, $Pincode, $license, $hashedPassword, $driver_active_status);
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="form-sample" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <div class="form-outline">
                                                    ...
                                                    <input type="text" id="fname" class="form-control" name="fname" onkeypress="return event.charCode >= 65 && event.charCode <= 123" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <div class="form-outline">
                                                    <label class="form-label" for="lname">Last Name<span style="color:red;">*</span></label>
                                                    <input type="text" id="lname" class="form-control" name="lname" onkeypress="return event.charCode >= 65 && event.charCode <= 123" />
                                                </div>
                                            </div>
                                            <script>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-outline">
                                                    <label class="form-label" for="pno">Primary Contact Number <span style="color:red;">*</span></label>
                                                    <input type="text" id="pno" class="form-control" name="pno" onkeypress="return event.charCode >= 47 && event.charCode <= 57" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label" for="sno">Secoundary Contact Number</label>
                                                <div class="form-outline">
                                                    <input type="text" id="sno" class="form-control" name="sno" onkeypress="return event.charCode >= 47 && event.charCode <= 57" />
                                                </div>
                                            </div>
                                            <!-- <div class="col-md-6 mb-3">
                                                <div class="form-outline">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-outline">
                                                    <label class="form-label" for="add">Address<span style="color:red;">*</span></label><br>
                                                    <input type="text" id="add" class="form-control" onkeypress="return event.charCode >= 65 && event.charCode <= 123" name="add" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <div class="form-outline">
                                                    <label class="form-label" for="city">City<span style="color:red;">*</span></label><br>
                                                    <input type="text" id="city" class="form-control" onkeypress="return event.charCode >= 65 && event.charCode <= 123" name="city" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <div class="form-outline">
                                                    <label class="form-label" for="pincode">Pincode<span style="color:red;">*</span></label>
                                                    <input type="text" id="pincode" class="form-control" onkeypress="return event.charCode >= 47 && event.charCode <= 57" name="pincode" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <div class="form-outline">
                                                    <label class="form-label" for="ln">Licens Number<span style="color:red;">*</span></label>
                                        ...
                                        <br>
                                        <input type="submit" class="btn btn-primary mt-3 p-2 " style="margin-left:45%;" name="adddriver" value="Add Driver" />
                                    </form>
                                </div>
                            </div>
                        </div>
