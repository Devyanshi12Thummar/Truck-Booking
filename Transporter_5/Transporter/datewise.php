...
$sqlmonthyear = "select MONTH(NOW()) as month,YEAR(NOW()) as year";
$monthresult = mysqli_query($conn, $sqlmonthyear);
$rowmonthyear = mysqli_fetch_assoc($monthresult);
$curmonth = $rowmonthyear['month'];
$curyear = $rowmonthyear['year'];
                                    ...
                                    <form method="post">
                                        <div class="form-outline">
                                            ...
                                            <script>
                                                ...
                                                initChart(<?php echo $curyear; ?>, <?php echo $curmonth; ?>);
                                            ...
                                            <br><br>
                                            <center>
                                                <label class="form-label" for="date"> Top 10 booked truck</label>
                                            </center>
                                            <br>
                                            <div style="width: 70%; margin: auto;">
                                                <canvas id="myChart"></canvas>
                                            ...
                                            <script>
                                                var ctx = document.getElementById('myChart').getContext('2d');
                                                var myChart;
                                                var year; // Define year as a global variable
                                                ...
                                                function fetchData(year, month) {
                                                    $.ajax({
                                                        ...
                                                        data: {
                                                            year: year,
                                                            month: month
                                                        }, // Pass the selected year and month as parameters
                                                        dataType: 'json',
                                                        success: function (data) {
                                                            myChart.data.labels = data.labels;
                                                            myChart.data.datasets[0].data = data.data;
