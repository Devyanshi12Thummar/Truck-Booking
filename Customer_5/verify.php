...
if (isset($_POST["submit"])) {
    ...
    try {
        ...
        //Recipients
        $mail->setFrom('truckbooking2023@gmail.com', 'Truck Booking System');
        $mail->addAddress($_SESSION["email"], 'truck booking');     //Add a recipient

        $mail->addReplyTo('truckbooking2023@gmail.com', 'Truck Booking System');
            ...
            <div class="col-lg-5 col-md-7 mx-auto my-auto">
                <div class="card">
                    <div class="card-body px-lg-5 py-lg-5 text-center">
                        ...
                        <h6 class="text-warning">OTP send in <?php echo $email; ?></h6>
