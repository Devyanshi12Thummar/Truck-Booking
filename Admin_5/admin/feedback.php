  ...
  <main id="main" class="main">
    ...
    <div class="row">
                        <div class="col-md-12 stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <p class="card-title">Feedback Details</p>
                                        ...
                                        <table id="customers">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Rating Service </th>
                                                    <th scope="col">Rating Performance</th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $row['rating_services']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row['rating_performance']; ?>
                                                        </td>
                                                        <td>
